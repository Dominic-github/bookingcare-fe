          ...
          <div className='Header-Content'>
                ...
                <div className='dropdown'>
                  ...
                  >
                    ...
                    <DropdownMenu>
                      ...
                      >
                        <FormattedMessage id='headerhomepage.speciality' />
                      </DropdownItem>
                      <DropdownItem
                        onClick={() => {
                          this.directToClinic()
                      ...
                      >
                        <FormattedMessage id='headerhomepage.health-facility' />
                      </DropdownItem>
                      <DropdownItem
                        onClick={() => {
                          this.directToDoctor()
                      ...
                      >
                        <FormattedMessage id='headerhomepage.doctor' />
                      </DropdownItem>
                      <DropdownItem
                        onClick={() => {
                      ...
                      >
                        <FormattedMessage id='headerhomepage.fee' />
                      </DropdownItem>
                    </DropdownMenu>
                  </Dropdown>
                </div>
            ...
            <div className='Center-Content'>
              ...
              >
                ...
                <div className='sub-title'>
                  <FormattedMessage id='headerhomepage.searchdoctor' />
                </div>
              </div>
              <div
                className='Child-Content'
              ...
              >
                ...
                <div className='sub-title'>
                  <FormattedMessage id='headerhomepage.select-room' />
                </div>
              </div>
              <div
                className='Child-Content'
              ...
              >
                ...
                <div className='sub-title'>
                  <FormattedMessage id='headerhomepage.select-doctor' />
                </div>
              </div>
              <div
                className='Child-Content'
              ...
              >
                ...
                <div className='sub-title'>
                  <FormattedMessage id='headerhomepage.health-check' />
                </div>
              </div>
            </div>
            <div className='Right-Content'>
              <div className='support'>
                ...
                <FormattedMessage id='headerhomepage.support' />
              </div>
              <div
                className={
              ...
              <div className='option'>
                ...
                >
                  ...
                  <div className='text-child'>
                    <FormattedMessage id='banner.icon1' />
                  </div>
                </div>
                <div
                  className='option-child'
                ...
                >
                  ...
                  <div className='text-child'>
                    <FormattedMessage id='banner.icon2' />
                  </div>
                </div>
                <div
                  className='option-child'
                ...
                >
                  ...
                  <div className='text-child'>
                    <FormattedMessage id='banner.icon3' />
                  </div>
                </div>
                <div
                  className='option-child'
                ...
                >
                  ...
                  <div className='text-child'>
                    <FormattedMessage id='banner.icon4' />
                  </div>
                </div>
                <div
                  className='option-child'
                ...
                >
                  ...
                  <div className='text-child'>
                    <FormattedMessage id='banner.icon5' />
                  </div>
                </div>
                <div className='option-child'>
                  ...
                  <div className='text-child'>
                    <FormattedMessage id='banner.icon6' />
                  </div>
                </div>
              </div>
            </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    changeLanguageAppRedux: (languageData) =>
      dispatch(changeLanguageApp(languageData)),
